...
// Session 16 v10 Phase H (Fix #9): revert to 4-step Session 12 wording.
const STEPS = [
  {
    num: 1,
    icon: "📥",
  ...
  return (
    ...
    >
      <style>{`
        ...
        /* Session 16 v10 Phase H (Fix #9): 4 cols again with Session 12 wording */
        .ftp-how-grid {
          display: grid;
        ...
        /* Session 16 v10 Phase H: gradient stripe revealed on hover */
        .ftp-how-step::before {
          content: "";
          position: absolute;
        ...
        .ftp-how-step:hover::before { opacity: 1; }
        .ftp-how-num-circle {
          width: 40px;
          height: 40px;
          border-radius: 50%;
