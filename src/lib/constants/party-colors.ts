...
const UNKNOWN: PartyTone = { bg: "#F9FAFB", border: "#9CA3AF", text: "#6B7280" };
...
export const PARTY_COLORS: Record<string, PartyTone> = {
  ...
  "AIADMK":        { bg: "#EFF6FF", border: "#1E3A8A", text: "#1E3A8A" },
  ...
  "TDP":           { bg: "#FFFBEB", border: "#EAB308", text: "#854D0E" },
...
export function getPartyColor(party: string | null | undefined): PartyTone {
  ...
  return PARTY_COLORS[party] ?? UNKNOWN;
}
